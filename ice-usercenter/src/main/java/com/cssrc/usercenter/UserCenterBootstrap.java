package com.cssrc.usercenter;


import com.cssrc.common.blockchain.ExecuteCommands;
import com.cssrc.common.blockchain.NoobChain;
import com.cssrc.common.blockchain.StringUtil;
import com.cssrc.usercenter.autoconfigure.MapperScan;
...
@EnableEurekaClient
@MapperScan("com.cssrc.usercenter.mapper")
@EnableFeignClients
...
public class UserCenterBootstrap {
    ...
    public static void main(String[] args) {
        ...
        ExecuteCommands server = new ExecuteCommands(2013,"server","");
    }
